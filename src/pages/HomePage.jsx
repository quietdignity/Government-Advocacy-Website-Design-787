    ...
    <div className="bg-cream-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl mb-4 text-soft-gray"
            >
            ...
            >
              ...
              <p className="text-sm text-soft-gray">60-day money-back guarantee</p>
            </motion.div>
          </div>
        </div>
      </section>
          ...
          <div className="text-center mb-16">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <motion.div
                ...
                className="bg-warm-orange border-l-4 border-bright-orange p-6 rounded-r-lg"
              >
            ...
            >
              ...
              <div className="flex space-x-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-navy-blue">Award Winner</span>
                </div>
                <div className="flex items-center space-x-2">
                  <SafeIcon icon={FiUsers} className="w-5 h-5 text-bright-orange" />
                  <span className="text-sm text-navy-blue">15+ Years Experience</span>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-cream-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            {features.map((feature, index) => (
              ...
              >
                ...
                <p className="text-navy-blue text-lg">{feature}</p>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              whileHover={{ y: -5 }}
              className="bg-light-blue p-6 rounded-lg border border-forest-green/20"
            >
              <h3 className="text-xl font-semibold text-navy-blue mb-4">40+ Professional Templates</h3>
            ...
            <motion.div
              whileHover={{ y: -5 }}
              className="bg-warm-orange p-6 rounded-lg border border-bright-orange/20"
            >
              <h3 className="text-xl font-semibold text-navy-blue mb-4">Video Walkthroughs</h3>
              <p className="text-navy-blue">
            ...
            <motion.div
              whileHover={{ y: -5 }}
              className="bg-light-blue p-6 rounded-lg border border-soft-gray/20"
            >
              <h3 className="text-xl font-semibold text-navy-blue mb-4">Audio Course</h3>
              <p className="text-navy-blue">
      ...
      <section className="py-20 bg-light-blue">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            whileHover={{ y: -10 }}
            className="max-w-2xl mx-auto bg-cream-white rounded-lg shadow-xl border border-soft-gray/20 overflow-hidden"
          >
            <div className="bg-bright-orange text-cream-white p-6 text-center">
              ...
              <p className="text-bright-orange/80 line-through">Regular Price: $1,997</p>
            </div>
